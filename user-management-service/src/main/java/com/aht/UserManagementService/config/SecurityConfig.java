...
import com.aht.UserManagementService.service.UserDetailsServiceImp;
...
//    }
    ...
    public TokenSettings tokenSettings() {
        return TokenSettings.builder()
                .accessTokenTimeToLive(Duration.ofMinutes(5L)) // Thời gian hết hạn là 30 phút
                .build();
    }
}